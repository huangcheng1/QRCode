...
@protocol SCCQRCodeCameraManagerDelegate <NSObject>
...
@interface SCCQRCodeCameraManager : NSObject

@property (nonatomic,weak) id<SCCQRCodeCameraManagerDelegate> delegate;
